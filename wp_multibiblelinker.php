...
/*
    ...
    Copyright 2013-2016 Vitaliy Bilanchuk (email: vitaly.bilanchuk@gmail.com), Vladimir Sokolov (email: gadfly.svy@gmail.com)
...
function add_css() {  
    wp_register_style('multibiblelinker-style', plugins_url('/css/multibiblelinker.css', __FILE__), array());  
    wp_enqueue_style('multibiblelinker-style');  
}
...
function multibiblelinker_add_option_pages() {
	if (function_exists('add_options_page')) {
	    add_options_page('Multipurpose Bible Linker', 'Multi Bible Linker', 'manage_options', basename(__FILE__), 'get_multibiblelinker_form');
	}		
}
